...
- **Entrega da lista Aula_XX_exercicios** (20% da nota final): As listas de exercícios devem ser enviadas em formado `PDF` via **Moodle** sempre *ao final de cada aula*.
