...
- **Envio do tema do trabalho** ($5\%$ da nota final): Envio via
  **Moodle** de um documento contendo os integrantes do grupo (**RA,
  Nome completo**) e um parágrafo descrevendo os objetivos do trabalho.
  O trabalho final será um ou mais **mapa(s) temático(s)** propostos
  para responder uma ou mais perguntas objetivas. Descreva: o título do
...
- **Envio da proposta de trabalho** ($10\%$ da nota final): O grupo
  deverá descrever todas as bases de dados, onde pretendem encontrá-las
  e qual será a metodologia de trabalho para a geração do mapa temático,
  isto é, qual serão as operações necessárias para processar as bases de
  dados a fim de gerar o(s) mapa(s) temático(s).

- **Envio das bases de dados que serão utilizadas no trabalho** ($10\%$
  da nota final): Cada grupo deverá disponibilizar as bases de dados em
...
- **Aula_XX_exercicios** ($30\%$ da nota final). As listas de exercícios
  deverão ser enviada via Moodle ao final de cada aula.
